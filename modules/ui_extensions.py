...
from modules.call_queue import wrap_ui_gpu_call
    ...
    with gr.Blocks(analytics_enabled=False) as ui:
        with gr.Tabs(elem_id="tabs_extensions"):
            with gr.TabItem("Installed", id="installed"):
                ...
                check.click(
                    fn=wrap_ui_gpu_call(check_updates, extra_outputs=[gr.update()]),
            ...
            with gr.TabItem("Available", id="available"):
                ...
                refresh_available_extensions_button.click(
                    fn=modules.ui.wrap_ui_call(refresh_available_extensions, extra_outputs=[gr.update(), gr.update(), gr.update(), gr.update()]),
                ...
                install_extension_button.click(
                    fn=modules.ui.wrap_ui_call_no_job(install_extension_from_index, extra_outputs=[gr.update(), gr.update()]),
                ...
                search_extensions_text.change(
                    fn=modules.ui.wrap_ui_call_no_job(search_extensions, extra_outputs=[gr.update()]),
                    inputs=[search_extensions_text, selected_tags, showing_type, filtering_type, sort_column],
                    outputs=[available_extensions_table, install_result],
                )

                selected_tags.change(
                    fn=modules.ui.wrap_ui_call_no_job(refresh_available_extensions_for_tags, extra_outputs=[gr.update()]),
            ...
            with gr.TabItem("Install from URL", id="install_from_url"):
                ...
                install_button.click(
                    fn=modules.ui.wrap_ui_call_no_job(lambda *args: [gr.update(), *install_extension_from_url(*args)], extra_outputs=[gr.update(), gr.update()]),
