...
(function(){
    ...
    onUiUpdate(() => {
        ...
        function attachEnabledButtonListener(checkbox, accordion) {
            if (!checkbox || !accordion) return;
            let span = accordion.querySelector('.label-wrap span');
            if (!span || span.querySelector('input.dynthres-enabled-badge')) return;
            ...
            badge.classList.add('primary', 'dynthres-enabled-badge');
            ...
            checkbox.addEventListener('change', () => {
                let badge = accordion.querySelector('.label-wrap span input.dynthres-enabled-badge');
                if (badge) badge.checked = checkbox.checked;
            });
