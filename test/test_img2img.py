...
def test_img2img_missing_init_images_returns_404(url_img2img, simple_img2img_request):
...
def test_img2img_invalid_mask_is_rejected(url_img2img, simple_img2img_request):
